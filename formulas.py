"This file contains the code for all the formulae used in the cvss calculator such as formula to calculate the base score, "
...
def exploitability_sub_score_modified(attack_vector_value_modified, 
                                      attack_complexity_value_modified,
