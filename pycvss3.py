...
@author: Dell
"""
"""this file firstly sets all the values of vectors to not defined.
further it defines the names to be used in each of the vector for eg. to enter the values of network in attack vector we have to 
type AV:N or AV:network.
It calls the entered values from the api_call file and returns the scores.
"""
...
class Vector(object):
    ...
    def get_vectors(self):
        ...
        for self.vector in self.vectors:
            ...
            if self.metric_vector == "CR":
                self.cr_metric = "set"
                if self.metric_value == "X" or self.metric_value == "not_defined" or self.metric_value == "not defined":
                    self.confidentiality_requirement_value = Metrics.cia_requirement.X
                elif self.metric_value == "H" or self.metric_value == "high":
                ...
                if self.cr_metric != "set":
                    self.confidentiality_requirement_value = Metrics.cia_requirement
            if self.metric_vector == "IR":
                self.ir_metric = "set"
                if self.metric_value == "X" or self.metric_value == "not_defined" or self.metric_value == "not defined":
                    self.integrity_requirement_value = Metrics.cia_requirement.X
                elif self.metric_value == "H" or self.metric_value == "high":
                ...
                if self.ir_metric != "set":
                    self.integrity_requirement_value = Metrics.cia_requirement

            if self.metric_vector == "AR":
                self.ar_metric = "set"
                if self.metric_value == "X" or self.metric_value == "not_defined" or self.metric_value == "not defined":
                    self.availability_requirement_value = Metrics.cia_requirement.X
                elif self.metric_value == "H" or self.metric_value == "high":
    ...
    def cvss_environmental_score(self):
        ...
        """
        self.exploitability_sub_score_value_modified = exploitability_sub_score_modified(self.attack_vector_value_modified,
        ...
        self.cvss_environmental_value = cvss_environmental_score(self.impact_sub_score_value_modified,
